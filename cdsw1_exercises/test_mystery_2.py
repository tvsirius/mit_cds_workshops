...
# from experiment it was found that mystery_2 get as input a list of lists and a value, and return list of lists from input, containing this value
...
class TestMystery_1(unittest.TestCase):
    ...
    def test_0(self):
        """tests empty list"""
        self.assertEqual(mystery_2([], 0),[])

    def test_1(self):
        """tests 1 element list"""
        self.assertEqual(mystery_2([[1]],1),[[1]])

    def test_11(self):
        """tests 1 element list no match"""
        self.assertEqual(mystery_2([[1]],2),[])

    def test_12(self):
        """tests list with empty lists"""
        self.assertEqual(mystery_2([[],[],[],[]],5),[])

    def test_2(self):
        """tests some lists"""
        self.assertEqual(mystery_2([[1,0,10,4,2],[1,5],[-5,1,2]],2),[[1,0,10,4,2],[-5,1,2]])

    def test_3(self):
        """tests some lists with no match"""
        self.assertEqual(mystery_2([[1.0],[0.0],[10.0],[4.0,5],[2.0,6,7]],648),[])

    def test_4(self):
        """tests some list"""
        self.assertEqual(mystery_2([[100.0,-4],[346,0,7,2,10,-4],[0,2],[7,10,100.0,346]],2),[[346,0,7,2,10,-4],[0,2]])

    def test_5(self):
        """tests list with different elements"""
        self.assertEqual(mystery_2([['e','f','l','a','b','z'],['432',4,'ss',1,3],[],['a','b','e','f'],['432',4,'ss',1,3,'f']],'f'),[['e','f','l','a','b','z'],['a','b','e','f'],['432',4,'ss',1,3,'f']])

    def test_6(self):
        """tests two big lists with numbers"""
        self.assertEqual(mystery_2([[5,1,7,4,-8,0,1,-1,1,1,1,-500,0,3,89,22,2,0,-5,-4,0,2,7,10,100.0,346,1,0,10,4,2,1.1e10,5e-10,5e5,9e-20,-7e16,8e100,6,2,7,4453,854678457,23,7,5,8,2,1,1,-634,-7457,-6346346,23,56,634],
    ...
    def test_8(self):
        ...
        self.assertTrue(mystery_2(L,element)==L_with_el)

    ## ---glass box tests (added after formatting function)

    def test_15(self):
        '''test for sting list'''
        self.assertEqual(mystery_2(['abc', 'a', 'bcde', 'sdgbdsdc'], 'b'), ['abc','bcde', 'sdgbdsdc'])

    def test_16(self):
        '''test for sting list and substring'''
        self.assertEqual(mystery_2(['abc', 'a', 'bdcde', 'sdgbdsdc','fsd'], 'bd'), [ 'bdcde', 'sdgbdsdc'])
