...
# from experiment, it was found that filter_collections get as input a list of lists and a value,
# and return list of lists from input, containing this value
# some glass box test added after formatting the function

class TestFilterCollections(unittest.TestCase):
    """
    A unittest test case for the 'filter_collections' function.

    This test case covers a variety of scenarios to ensure the correctness of the 'filter_collections' function,
    ...
    def test_0(self):
        """tests empty list"""
        self.assertEqual(filter_collections([], 0), [])

    def test_1(self):
        """tests 1 element list"""
        self.assertEqual(filter_collections([[1]], 1), [[1]])

    def test_11(self):
        """tests 1 element list no match"""
        self.assertEqual(filter_collections([[1]], 2), [])

    def test_12(self):
        """tests list with empty lists"""
        self.assertEqual(filter_collections([[], [], [], []], 5), [])

    def test_2(self):
        """tests some lists"""
        self.assertEqual(filter_collections([[1, 0, 10, 4, 2], [1, 5], [-5, 1, 2]], 2), [[1, 0, 10, 4, 2], [-5, 1, 2]])

    def test_3(self):
        """tests some lists with no match"""
        self.assertEqual(filter_collections([[1.0], [0.0], [10.0], [4.0, 5], [2.0, 6, 7]], 648), [])

    def test_4(self):
        """tests some list"""
        self.assertEqual(filter_collections([[100.0, -4], [346, 0, 7, 2, 10, -4], [0, 2], [7, 10, 100.0, 346]], 2),
                         [[346, 0, 7, 2, 10, -4], [0, 2]])

    def test_6(self):
        """tests two big lists with numbers"""
        self.assertEqual(
            filter_collections([[5, 1, 7, 4, -8, 0, 1, -1, 1, 1, 1, -500, 0, 3, 89, 22, 2, 0, -5, -4, 0, 2, 7,
    ...
    def test_8(self):
        ...
        self.assertTrue(filter_collections(L, element) == L_with_el)

    ## ---glass box tests (added after formatting function)

    def test_15(self):
        '''test for sting list'''
        self.assertEqual(filter_collections(['abc', 'a', 'bcde', 'sdgbdsdc'], 'b'), ['abc', 'bcde', 'sdgbdsdc'])

    def test_16(self):
        '''test for sting list and substring'''
        self.assertEqual(filter_collections(['abc', 'a', 'bdcde', 'sdgbdsdc', 'fsd'], 'bd'), ['bdcde', 'sdgbdsdc'])
    ...
    def test_assert1(self):
        ...
        with self.assertRaises(AssertionError):
            filter_collections([4, 5], 3)

    def test_assert2(self):
        """test L assertion is list of iterables"""
        with self.assertRaises(AssertionError):
            filter_collections([4, 5, 6], 's')

    def test_assert3(self):
        """test L assertion is list of str and elem must be string"""
        with self.assertRaises(AssertionError):
            filter_collections(['fdfg', 'sdgsdg', 'dfd'], 3)
